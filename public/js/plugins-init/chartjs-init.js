 ...
 var dzSparkLine = function(){
					...
					datasets: [
						{
							...
							borderColor: 'rgba(55,54,175,1))',
							borderWidth: "0",
							backgroundColor: 'rgba(55,54,175,1)',
							barPercentage: 0.5,
						}
					]
				},
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(55,54,175,1)");
					...
					datasets: [
						{
							...
							pointBackgroundColor: 'rgba(55,54,175,1)',
							tension: 0.5,
						}
					]
				},
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(55,54,175,1)");
			...
			class Custom extends Chart.LineController {
				draw() {
					...
					ctx.stroke = function(){
						ctx.save();
						ctx.shadowColor = 'rgba(30, 170, 231, 0.2)';
						ctx.shadowBlur = 10;
						ctx.shadowOffsetX = 0;
						ctx.shadowOffsetY = 4;
						_stroke.apply(this, arguments);
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(55,54,175,1)");
