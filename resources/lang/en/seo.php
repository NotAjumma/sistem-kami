...
return [
    'home' => [
        'title'       => 'Sistem Kami | Event Organizer & Vendor Booking Platform',
        'description' => 'Sistem Kami provides a platform for event organizers to host and manage events, and for vendors to list and manage their services and bookings — all in one place.',
    ],
    'about' => [
