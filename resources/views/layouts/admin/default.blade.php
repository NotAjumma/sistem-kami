	...
	<div id="main-wrapper" class="{{ in_array($page, array('dashboard', 'dashboard_2')) ? '' : '' }}">
        ...
        ***********************************-->
		<div class="nav-header">
			<a href="{{ route('organizer.dashboard') }}" class="brand-logo">
				<img id="brand-logo-img" src="{{ asset('images/logo-white.png') }}" alt="Sistem Kami Logo" class="img-fluid h-5 w-auto">
			</a>
        ...
        ***********************************-->
		<div class="footer style-1">
			<div class="copyright">
				<p>Copyright © Designed &amp; Developed by <a href="" target="_blank">SistemKami</a> <span
