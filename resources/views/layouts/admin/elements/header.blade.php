...
<div class="header {{ in_array($page, ['dashboard', 'dashboard_2']) ? 'home' : '' }}">
                        ...
                        <span class="input-group-text"><a href="javascript:void(0)">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    ...
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <path
                                            d="M14.2928932,16.7071068 C13.9023689,16.3165825 13.9023689,15.6834175 14.2928932,15.2928932 C14.6834175,14.9023689 15.3165825,14.9023689 15.7071068,15.2928932 L19.7071068,19.2928932 C20.0976311,19.6834175 20.0976311,20.3165825 19.7071068,20.7071068 C19.3165825,21.0976311 18.6834175,21.0976311 18.2928932,20.7071068 L14.2928932,16.7071068 Z"
                                            fill="var(--primary)" fill-rule="nonzero" opacity="0.3"></path>
                                        <path
                                            d="M11,16 C13.7614237,16 16,13.7614237 16,11 C16,8.23857625 13.7614237,6 11,6 C8.23857625,6 6,8.23857625 6,11 C6,13.7614237 8.23857625,16 11,16 Z M11,18 C7.13400675,18 4,14.8659932 4,11 C4,7.13400675 7.13400675,4 11,4 C14.8659932,4 18,7.13400675 18,11 C18,14.8659932 14.8659932,18 11,18 Z"
                            ...
                            <div id="DZ_W_Notification1" class="widget-media dlab-scroll p-3" style="height:380px;">
                                <ul class="timeline">
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="me-2 search-p">
                                                <svg class="one" width="25" height="25"
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="me-2 search-p">
                                                <svg class="two" width="25" height="25"
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="me-2 search-p">
                                                <svg class="three" width="25" height="25"
                                                    viewBox="0 0 42 42" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="me-2 search-p">
                                                <svg class="four" width="25" height="25"
                                                    viewBox="0 0 56 56" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M37.3334 22.167C37.3318 20.2347 35.7654 18.6688 33.8336 18.6667H23.3334V25.6667H33.8336C35.7654 25.6651 37.3318 24.0987 37.3334 22.167Z"
                                ...
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown"
                                    ...
                                    <div class="header-info2 d-flex align-items-center">
                                        <div class="d-flex align-items-center sidebar-info">
                                            <div>
                                                <h5 class="mb-0 text-white">{{ $authUser->name }}</h5>
                                                <span class="d-block text-end">@ {{ $authUser->user->username }}</span>
                                            </div>
                                        </div>
                                        <img src="{{ $authUser->logo_url ?? asset('storage/uploads/default-organizer-logo.jpg') }}" alt="{{ $authUser->name }} logo">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                   ...
                                   @php
                                        ...
                                        $logoutRoute = match ($role) {
                                            'admin' => 'admin.logout',
                                            'organizer' => 'organizer.logout',
                                            default => 'logout',
                                        };
                                        \Log::info($logoutRoute);
    ...
    @if (in_array($page, ['dashboard', 'dashboard_2']))
                ...
                <li class="breadcrumb-item active ms-auto">
                    ...
                    <a class="d-flex align-self-center" href="{{ route('organizer.dashboard') }}">
                        <svg class="me-2 svg-main-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"></rect>
                                <path d="M3.95709826,8.41510662 L11.47855,3.81866389 C11.7986624,3.62303967 12.2013376,3.62303967 12.52145,3.81866389 L20.0429,8.41510557 C20.6374094,8.77841684 21,9.42493654 21,10.1216692 L21,19.0000642 C21,20.1046337 20.1045695,21.0000642 19,21.0000642 L4.99998155,21.0000673 C3.89541205,21.0000673 2.99998155,20.1046368 2.99998155,19.0000673 L2.99999828,10.1216672 C2.99999935,9.42493561 3.36258984,8.77841732 3.95709826,8.41510662 Z M10,13 C9.44771525,13 9,13.4477153 9,14 L9,17 C9,17.5522847 9.44771525,18 10,18 L14,18 C14.5522847,18 15,17.5522847 15,17 L15,14 C15,13.4477153 14.5522847,13 14,13 L10,13 Z" fill="#aaa9ff"></path>
                            </g>
                        </svg>
                        {{ isset($main_title) ? $main_title : 'Home' }}
                    </a>
                </li>
                <li class="breadcrumb-item"><a href="javascript:void(0)">{{ isset($page_title) ? $page_title : '' }}</a></li>
            </ol>
        </div>
    @endif
</div>
