            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Select2 also supports multi-value select boxes. The select below is declared with the
                            multiple <code class="text-danger">attribute</code>.</p>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>In HTML, <code>&lt;option&gt;</code> elements can be grouped by wrapping them with in <br> an
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Select2 will correctly handle disabled options when <code>disabled</code> attribute is set)
                            and from remote srouces where the object has <code>disabled:
                                true</code> set.</p>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>You can, and should, use a <code>&lt;label&gt;</code> with Select2, just like any other
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>The two Select2 boxes below are styled to <code>50%</code> and <code>75%</code> width
                            respectively to support responsive design:</p>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Select2 supports custom themes using the <code>theme</code> option so you can style Select2
                            to match the rest of your application.</p>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Select2 comes with AJAX support built in, using jQuery's AJAX methods. In this example, we
                            can search for repositories using GitHub's API:</p>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>You may use the <code>data</code> configuration option to load dropdown options from a local
                            array.</p>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Select2 can be configured to automatically select the currently highlighted result when the
                            dropdown is btn-closed by using the <code>selectOnbtn-close</code> option:
                        </p>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Select2 will automatically btn-close the dropdown when an element is selected, similar to
                            what is done with a normal select box. You may use the
                            <code>btn-closeOnSelect</code> option to prevent the dropdown from closing when a result is
                            selected:
                        </p>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>The <code>dropdownParent</code> option allows you to pick an alternative element for the
                            dropdown to be appended to:</p>
                    </div>
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Select2 multi-value select boxes can set restrictions regarding the maximum number of options
                            that can be selected. The select below is declared with the
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>In addition to a prepopulated menu of options, Select2 can dynamically create new options
                            from text input by the user in the search box. This feature is called "tagging". To enable
                            tagging, set the <code>tags</code> option to
                            <code>true</code>:
                        </p>
                    </div>
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Tagging can also be used in multi-value select boxes. In the example below, we set the
                            <code>multiple="multiple"</code> attribute on a Select2 control that also has <code>tags:
                                true</code> enabled:</p>
                    </div>
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Select2 supports displaying a placeholder value using the
                            <code>placeholder</code> configuration option. The placeholder value will be displayed until
                            a selection is made.
                        </p>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Alternatively, the value of the <code>placeholder</code> option can be a data object
                            representing a default selection (<code>&lt;option&gt;</code>). In this case the
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>When users filter down the results by entering search terms into the search box, Select2 uses
                            an internal "matcher" to match search terms to results. You may customize the way that
                            Select2 matches search terms by specifying
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Only first-level objects will be passed in to the <code>matcher</code> callback. If you are
                            working with nested data, you must iterate through the
                            <code>children</code> array and match them individually. This allows for more advanced
                            matching when working with nested objects, allowing you to handle them however you want.
                        </p>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>New options can be added to a Select2 control programmatically by creating a new Javascript
                            <code>Option</code> object and appending it to the control:</p>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>You can use <code>.find</code> to select the option if it already exists, and create it
                            otherwise:</p>
                    </div>
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Select2 will work on RTL websites if the <code>dir</code> attribute is set on the
                            <code>&lt;select&gt;</code><span class="copy-to-clipboard"
                                title="Copy to clipboard"></span> or any parents of it. You can also initialize Select2
                            with the <code>dir: "rtl"</code><span class="copy-to-clipboard"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>The <code>destroy</code> method will remove the Select2 widget from the target element. It
                            will revert back to a standard <code>select</code> control:</p>
                    </div>

                    <div class="mb-4">
                        <select class="destroy-selector default-select" style ="width: 100%;">
                            <option value="Alaska">Alaska</option>
                            <option value="Hawaii">Hawaii</option>
                            <option value="California">California</option>
                        </select>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <p>Select2 will trigger a few different events when different actions are taken using the
                            component, allowing you to add custom hooks and perform actions.</p>
                    </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <button class="js-programmatic-multi-set-val btn btn-primary mb-2"
