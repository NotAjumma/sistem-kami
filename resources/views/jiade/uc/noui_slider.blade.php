            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="slider-update ">
                        ...
                        <button class="update-button btn btn-primary btn-sm mb-2" id="update-1">Set range [20,
                            50]</button>
                        <button class="update-button btn btn-info btn-sm mb-2" id="update-2">Set range [10,
                            40]</button>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="locked-slider">
                        ...
                        <button class="btn btn-danger btn-sm mt-4" id="lockbutton"
