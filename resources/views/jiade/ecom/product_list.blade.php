                    ...
                    <div class="row m-b-30">
                        ...
                        <div class="col-md-7 col-xxl-12">
                            <div class="new-arrival-content position-relative">
                                <h4><a href="{{ url('ecom-product-detail') }}">Bitcoin: Decoding the Digital Revolution in
                                        Finance</a></h4>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row m-b-30">
                        ...
                        <div class="col-md-7 col-xxl-12">
                            <div class="new-arrival-content position-relative">
                                <h4><a href="{{ url('ecom-product-detail') }}">Bitcoin Unleashed: Financial Frontier</a></h4>
                                <div class="comment-review star-rating">
                                    <ul>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row m-b-30">
                        ...
                        <div class="col-md-7 col-xxl-12">
                            <div class="new-arrival-content position-relative">
                                <h4><a href="{{ url('ecom-product-detail') }}">Bitcoin: Future Finance Frontier</a></h4>
                                <div class="comment-review star-rating">
                                    <ul>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row m-b-30">
                        ...
                        <div class="col-md-7 col-xxl-12">
                            <div class="new-arrival-content position-relative">
                                <h4><a href="{{ url('ecom-product-detail') }}">Bitcoin Ascendancy: Digital Epoch</a></h4>
                                <div class="comment-review star-rating">
                                    <ul>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row m-b-30">
                        ...
                        <div class="col-md-7 col-xxl-12">
                            <div class="new-arrival-content position-relative">
                                <h4><a href="{{ url('ecom-product-detail') }}">Bitcoin: Catalyst for Change</a></h4>
                                <div class="comment-review star-rating">
                                    <ul>
                                        <li><i class="fa fa-star"></i></li>
                                        <li><i class="fa fa-star"></i></li>
