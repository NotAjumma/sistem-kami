                        ...
                        <table class="table table-sm mb-0">
                            ...
                            <tbody id="orders">
                                <tr class="btn-reveal-trigger">
                                    ...
                                    <td class="py-2">
                                        <a href="#">
                                            ...
                                            Antony</strong><br><a href="mailto:ricky@example.com">ricky@example.com</a>
                                    </td>
                                        ...
                                        <div class="dropdown text-sans-serif"><button
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end border py-0"
                                                ...
                                                <div class="py-2"><a class="dropdown-item"
                                                        href="javascript:void(0);">Completed</a><a class="dropdown-item"
                                                        href="javascript:void(0);">Processing</a><a
                                                        class="dropdown-item" href="javascript:void(0);">On Hold</a><a
                                                        class="dropdown-item" href="javascript:void(0);">Pending</a>
                                ...
                                <tr class="btn-reveal-trigger">
                                    ...
                                    <td class="py-2">
                                        <a href="#">
                                            ...
                                            Diana</strong><br><a href="mailto:merry@example.com">merry@example.com</a>
                                    </td>
                                    ...
                                    <td class="py-2 text-end"><span class="badge badge-secondary badge-sm badge-sm">On
                                ...
                                <tr class="btn-reveal-trigger">
                                    ...
                                    <td class="py-2">
                                        <a href="#">
                                            ...
                                            Robert</strong><br><a href="mailto:bucky@example.com">bucky@example.com</a>
                                    </td>
                                    <td class="py-2">30/04/2020</td>
                                    ...
                                    <td class="py-2 text-end"><span
                                            class="badge badge-warning badge-sm badge-sm">Pending<span
                                ...
                                <tr class="btn-reveal-trigger">
                                    ...
                                    <td class="py-2">
                                        <a href="#">
                                            ...
                                            Zampa</strong><br><a href="mailto:rocky@example.com">rocky@example.com</a>
                                    </td>
                                    <td class="py-2">30/04/2020</td>
                                ...
                                <tr class="btn-reveal-trigger">
                                    ...
                                    <td class="py-2 text-end"><span
                                            class="badge badge-success badge-sm badge-sm">Completed<span
                                                class="ms-1 fa fa-check"></span></span>
                                    </td>
                                ...
                                <tr class="btn-reveal-trigger">
                                    ...
                                    <td class="py-2 text-end"><span
                                            class="badge badge-primary badge-sm badge-sm">Processing<span
                                                class="ms-1 fa fa-redo"></span></span>
                                    </td>
                                ...
                                <tr class="btn-reveal-trigger">
                                    ...
                                    <td class="py-2">
                                        <a href="#">
                                            ...
                                            Peters</strong><br><a href="mailto:peter@example.com">peter@example.com</a>
                                    </td>
                                    <td class="py-2">29/04/2020</td>
                                ...
                                <tr class="btn-reveal-trigger">
                                    ...
                                    <td class="py-2 border-0">28/04/2020</td>
                                    <td class="py-2 border-0">Jennifer Johnson, Rhyd Y Groes, Rhosgoch, LL66 0AT
                                        <p class="mb-0 text-500">Via Flat Rate</p>
                                    </td>
                                    <td class="py-2 text-end border-0"><span
                                            class="badge badge-primary badge-sm">Processing<span
                                                class="ms-1 fa fa-redo"></span></span>
                                    </td>
                                    <td class="py-2 text-end border-0">$112
                                    </td>
                                    <td class="py-2 text-end border-0">
                                        <div class="dropdown text-sans-serif"><button
                                                class="btn btn-primary tp-btn-light sharp" type="button"
