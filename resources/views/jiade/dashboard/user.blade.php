            ...
            <div class="row">
                <div class="col-xl-12 col-md-12">
                    <div class="card justify-content-center">
                        <div class="card-body d-flex">
                            <div class="d-block">
                                <img src="{{ asset('images/profile/pic1.jpg') }}" class="avatar avatar-xxl border-primary rounded-circle"
                                    alt="">
                            </div>
                            <div class="w-100 ps-4">
                                <div class="d-flex justify-content-between">
                                    <div class="">
                                        <h4 class="card-title mb-1"> Nadila Adja </h4>
                                        <h5> UI Designer </h5>
                                        <span> London, United Kingdom </span>
                                    </div>
                                    <div class="d-flex">
                                        <div class="icon-box icon-box-sm bgl-danger me-2 btn-edit">
                                        ...
                                        <div class="dropdown ms-auto">
                                            <a href="javascript:void(0)" class="icon-box icon-box-sm bgl-primary"
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li class="dropdown-item"><a href="javascript:void(0);"><i
                                                        ...
                                                        friends </a></li>
                                                <li class="dropdown-item"><a href="javascript:void(0);"><i
                                                            class="fa fa-plus text-primary me-2"></i> Add to group </a>
                                                </li>
                                                <li class="dropdown-item"><a href="javascript:void(0);"><i
                                                            class="fa fa-ban text-primary me-2"></i> Block </a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex flex-wrap pt-4">
                                    <div class="d-flex align-items-center pe-md-4 pe-2 mb-2">
                                        ...
                                        <h5 class="font-w400 mb-0">demo@gmail.com</h5>
                                    </div>
                                    <div class="d-flex align-items-center pe-md-4 pe-2 mb-2">
                                        <div class="pe-2">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                        ...
                                        <h5 class="font-w400 mb-0">+012 345 689</h5>
                                    </div>
                                    <div class="d-flex align-items-center pe-md-4 pe-2 mb-2">
                                        <div class="pe-2">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                        ...
                                        <h5 class="font-w400 mb-0">Jiade Studios</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="card">
                        <div class="card-header border-0 pb-0 d-block">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <span>You have <strong class="text-primary">456</strong> contacts</span>
                                </div>
                            ...
                            <div class="input-group custom-search-area mt-3">
                        ...
                        <div class="card-body pt-4 pb-0 height370 dlab-scroll">
                            <div class="contacts-list" id="RecentActivityContent">
                                <div class="d-flex justify-content-between my-3 border-bottom-dashed pb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <span class="fs-14 text-muted">Marketing Manager</span>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex justify-content-between mt-3 mb-0 border-bottom-dashed pb-3">
                                    <div class="d-flex align-items-center">
                        ...
                        <div class="card-footer border-0 pt-0">
                            <div class="text-center border-0">
                                <a href="javascript:void(0);" class="btn btn-block btn-primary btn-sm dlab-load-more"
                                    id="RecentActivity" rel="{{ route('ajax_message') }}">View More</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12">
                    <div class="card">
                        <div class="card-header d-block border-0 pb-0 ">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3 class="card-title mb-1">Messages</h3>
                                    <span>You have <strong class="text-primary">10 New</strong> Messages</span>
                                </div>
                                <a class="icon-box icon-box-sm bg-primary" href="#" data-bs-toggle="modal"
                        ...
                        <div class="card-body height370 dlab-scroll pt-4 pb-0">
                                ...
                                <div class="d-flex justify-content-between mb-3 mt-3 border-bottom-dashed pb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <span class="fs-14 text-muted text-wrap">Lorem ipsum dolor sit
                                                amet...</span>
                                        </div>
                                    </div>
                                    <div class="text-end">
                        ...
                        <div class="card-footer border-0 pt-0">
                            <div class="text-center border-0 pt-3">
                                <a href="javascript:void(0);" class="btn btn-block btn-primary dlab-load-more btn-sm"
                                    id="RecentMessages" rel="{{ route('ajax_contacts') }}">View More</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-4">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="prot-blog">
                            ...
                            <div class="fill">
                                ...
                                <p class="mb-1">Expired on December 30th, 2022</p>
                            </div>
                            <h4 class="mb-0">
                                <a href="{{ url('post-details') }}" class="text-bla"><svg class="me-1" width="9"
                            ...
                            <h4 class="mb-3">
                                <a href="{{ url('post-details') }}" class="text-bla">
                                    <svg class="me-1" width="9" height="9" viewBox="0 0 9 9"
                ...
                <div class="col-xl-12 col-lg-6 ">
                    <div class="card">
                        <div class="card-header border-0 pb-0 ">
                            <h3 class="card-title mb-2">Task</h3>
                        </div>
                        <div class="card-body pt-2">
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div class="ms-3">
                                    <h5 class="mb-1"><a class="text-primary" href="{{ url('activity') }}">To Do</a></h5>
                                    <ul class="d-flex">
                                        <li class="me-3">5 Task Now</li>
                                        <li><svg width="6" class="me-3" height="7" viewBox="0 0 6 7"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div class="ms-3">
                                    <h5 class="mb-1"><a class="text-secondary" href="{{ url('activity') }}">In Progress</a>
                                    </h5>
                                    <ul class="d-flex">
                                        <li class="me-3">5 Task Now</li>
                                        <li><svg width="6" class="me-3" height="7" viewBox="0 0 6 7"
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <h5 class="mb-1"><a class="text-success" href="{{ url('activity') }}">Completed</a>
                                    </h5>
                                    <ul class="d-flex">
                                        <li class="me-3">15 Task Now</li>
                                        <li><svg width="6" class="me-3" height="7" viewBox="0 0 6 7"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="3" cy="3.5" r="3" fill="#C4C4C4"></circle>
                                            </svg>
                ...
                <div class="col-xl-12 col-md-12 ">
                    <div class="card">
                        <div class="card-header border-0 pb-0">
                            <h3 class="card-title mb-0">Lastest Activity</h3>
                        </div>
                            ...
                            <div class="dz-scroll">
                                <ul class="timeline-active">
                                    <li class="d-flex timeline-list">
                                        <div class="dz-media">
                                            <img src="./images/profile/14.jpg" alt="" class="avatar">
                                        </div>
                                        <div class="panel">
                                            <a class="timeline-panel text-muted d-flex align-items-center mb-0"
                                                href="#">
                                                <h4 class="mb-0"><strong>Karen Hope</strong> moved task <strong
                                                        class="text-primary">Jiade Projects</strong> </h4>
                                            </a>
                                    ...
                                    <li class="d-flex timeline-list">
                                        <div class="dz-media">
                                            <img src="./images/profile/18.jpg" alt="" class="avatar">
                                        </div>
                                        <div class="panel">
                                            <a class="timeline-panel text-muted d-flex align-items-center mb-0"
                                                href="#">
                                                <h4 class="mb-0"><strong>Tony Soap </strong> commented at <strong
                                                        class="text-primary"> Jiade Projects </strong></h4>
                                            </a>
                                            <span class="time py-0">Monday, June 31 2020</span>
                                    ...
                                    <li class="d-flex timeline-list pb-0">
                                        <div class="dz-media">
                                            <img src="./images/profile/19.jpg" alt="" class="avatar">
                                        </div>
                                        <div class="panel">
                                            <a class="timeline-panel text-muted d-flex align-items-center mb-0"
                                                href="#">
                                                <h4 class="mb-0"><strong>Samantha William </strong> add 4 files on
                                                    Jiade <strong class="text-danger">Projects </strong></h4>
                                            </a>
                                            <span class="time py-0">Monday, June 31 2020</span>
                                        </div>
