                ...
                <div class="col-xl-12">
                    <div class="card prim-card">
                        <div class="card-body">
                            ...
                            <img src="{{ asset('images/atm-chip.png') }}" alt="">
                            <div class="d-flex align-items-end justify-content-between">
                                ...
                                <div class="master-card">
                                    <svg width="55" height="35" viewBox="0 0 55 35" fill="none"
                                        ...
                                        <circle opacity="0.7" cx="17.5" cy="17.5" r="17.5"
                                            fill="#eb001b">
                                        </circle>
                                        <circle opacity="0.7" cx="37.5" cy="17.5" r="17.5"
                                            fill="#f79e1b">
                                        </circle>
                                    </svg>
                            ...
                            <div class="d-flex mb-3">
                                ...
                                <div class="ps-2 w-100 flex-1">
                                    ...
                                    <div class="progress mt-2 h-auto">
                                        <div class="progress-bar bg-primary" style="width:50% ; height:6px;"></div>
                                    </div>
