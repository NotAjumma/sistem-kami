        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <h4 class="me-4 font-w600 mb-0"><span class="text-success me-2">BUY</span>
                                                    $5,673</h4>
                                    ...
                                    <div class="card-body py-0">
                                        <div class="text-center">
                                            <div class="media d-block">
                                                <svg width="80" height="80" viewBox="0 0 126 126" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                ...
                                                <div class="media-content">
                                                    <h4 class="mt-0 mt-md-4 fs-20 font-w700 text-dark mb-0">Digital Cash
                                                    </h4>
                                                    <span class="font-w600 text-dark">Bitcoin</span>
                                                    <span class="my-4 fs-16 font-w600 d-block">1 BITCOIN = 43,474.50
                                                        USD</span>
                                                    <p class="text-start">Dash is an open source cryptocurrency. It is an
                                                        altcoin that was forked from the Bitcoin protocol. It is also a
                                                        decentralized autonomous organization (DAO)...</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card price-list">
                                    ...
                                    <div class="card-footer text-center py-3 border-0">
                                        <a href="{{ url('coin-details') }}" class="btn-link text-warning">Show more <i
                            ...
                            <div class="col-xl-3 col-sm-">
                                <div class="card price-list">
                                    ...
                                    <div class="card-footer text-center py-3 border-0">
                                        <a href="{{ url('coin-details') }}" class="btn-link text-danger">Show more <i
                    ...
                    <div class="tab-pane fade show " id="nav-etherum" role="tabpanel" aria-labelledby="nav-etherum-tab">
                        <div class="row">
                            <div class="col-xl-9">
                                <div class="card coin-content">
                                    <div class="card-header border-0 flex-wrap pb-0">
                                        ...
                                        <div class="guest-calendar d-flex align-items-center">
                                            ...
                                            <div id="reportrange1" class="pull-right reportrange" style="width: 100%">
                                                <span></span><b class="caret"></b>
                                                <i class="fas fa-chevron-down ms-sm-3 ms-0"></i>
                                            </div>
                                        </div>
                                ...
                                <div class="card coin-content">
                                    <div class="card-header border-0 flex-wrap pb-0">
                                        ...
                                        <div class="guest-calendar d-flex align-items-center">
                                            ...
                                            <div id="reportrange3" class="pull-right reportrange" style="width: 100%">
                                                <span></span><b class="caret"></b>
                                                <i class="fas fa-chevron-down ms-sm-3 ms-0"></i>
                                            </div>
                                        </div>
                                ...
                                <div class="card coin-content">
                                    <div class="card-header border-0 flex-wrap pb-0">
                                        ...
                                        <div class="guest-calendar d-flex align-items-center">
                                            ...
                                            <div id="reportrange4" class="pull-right reportrange" style="width: 100%">
                                                <span></span><b class="caret"></b>
                                                <i class="fas fa-chevron-down ms-sm-3 ms-0"></i>
                                            </div>
                                        </div>
                                            ...
                                            <div class="media d-block">
                                                ...
                                                <div class="media-content">
                                                    ...
                                                    <span class="my-4 fs-16 font-w600 d-block">1 LITCOIN = 43,474.50
                                                        USD</span>
                                                    <p class="text-start">Dash is an open source cryptocurrency. It is an
                                                        altcoin that was forked from the LITCOIN protocol. It is also a
                                                        decentralized autonomous organization (DAO)...</p>
                                                </div>
                                            </div>
                                        </div>
