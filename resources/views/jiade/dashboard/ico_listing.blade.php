                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card pull-up">
                        <div class="card-body align-items-center flex-wrap">
                            <div class="d-flex align-items-center mb-4">
                                <a href="javascript:void(0)" class="ico-icon">
                                    <img src="{{ asset('images/svg/ethereum-1.svg') }}" alt="">
                                </a>
                                <div class="ms-3">
                                    <a href="javascript:void(0)">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card pull-up">
                        <div class="card-body align-items-center flex-wrap">
                            <div class="d-flex align-items-center mb-4">
                                <a href="javascript:void(0)" class="ico-icon">
                                    <img src="{{ asset('images/svg/ripple-1.svg') }}" alt="">
                                </a>
                                <div class="ms-3">
                                    <a href="javascript:void(0)">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card pull-up">
                        <div class="card-body align-items-center flex-wrap">
                            <div class="d-flex align-items-center mb-4">
                                <a href="javascript:void(0)" class="ico-icon">
                                    <img src="{{ asset('images/svg/dash-pink.svg') }}" alt="">
                                </a>
                                <div class="ms-3">
                                    <a href="javascript:void(0)">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card pull-up">
                        <div class="card-body align-items-center flex-wrap">
                            <div class="d-flex align-items-center mb-4">
                                <a href="javascript:void(0)" class="ico-icon">
                                    <img src="{{ asset('images/svg/litecoin-1.svg') }}" alt="">
                                </a>
                                <div class="ms-3">
                                    <a href="javascript:void(0)">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="card pull-up">
                        <div class="card-body align-items-center flex-wrap">
                            <div class="d-flex align-items-center mb-4">
                                <a href="javascript:void(0)" class="ico-icon">
                                    <img src="{{ asset('images/svg/ltc.svg') }}" alt="">
                                </a>
                                <div class="ms-3">
                                    <a href="javascript:void(0)">
