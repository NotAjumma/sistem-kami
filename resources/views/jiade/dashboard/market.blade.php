    ...
    <div class="row">
        <div class="col-xl-3 col-xxl-4 col-sm-6 my-order-ile">
            <div class="card">
                            ...
                            <span>
                                <svg width="38" height="38" viewBox="0 0 42 42" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="#00ADA3" />
                                    <path d="M21.0002 21L26.2502 18.9001L21.0002 10.5L15.7502 18.9001L21.0002 21Z"
                                        fill="#00ADA3" />
                                    <path
                ...
                <div class="card-footer border-0 pt-0">
                    <a href="{{ url('trading-market') }}" class="btn btn-primary d-block btn-sm">Show more <i
                            ...
                            <div class="market-coin flex-wrap">
                                <div class="d-flex align-items-center coin-box">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <a href="javascript:void(0);">
                                            <h4 class="font-w600 mb-0">BTC / USD</h4>
                                        </a>
                                    </div>
                                </div>
                                <div class="coin-box">
                            ...
                            <div class="d-flex align-items-center flex-wrap mb-3 mb-sm-0">
                                ...
                                <span>
                                    <svg width="19" height="19" viewBox="0 0 19 19" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M7.52549 0V7.71177H0V11.2882H7.52549V19H11.4745V11.2882H19V7.71177H11.4745V0H7.52549Z"
                                            fill="var(--primary)" />
                                    </svg>
        ...
        <div class="col-xl-3 col-xxl-4 col-sm-6 my-order-ile-2">
            <div class="card trade-history">
                ...
                <div class="card-footer border-0 pt-0">
                    <a href="{{ url('history') }}" class="btn btn-primary d-block btn-sm">Show more <i
                            class="fa-solid fa-caret-right ms-2"></i></a>
                </div>
            </div>
        </div>
                    ...
                    <div class="bar-chart d-flex justify-content-between flex-wrap align-items-baseline">
                        <div>
                            <div class="d-flex align-items-center">
                                ...
                                <span class="fs-22 font-w400 d-block ms-2 text-success">7%<i
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <ul class="nav nav-pills me-4" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="Week-bar-tab" href="#Week-bar"
                                        data-bs-toggle="tab" data-bs-target="#Week-bar" role="tab"
                                        aria-selected="true">Week</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="Month-bar-tab" data-bs-toggle="tab" href="#Month-bar"
                                        data-bs-target="#Month-bar" role="tab" aria-selected="false">Month</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="Year-bar-tab" data-bs-toggle="tab" href="#Year-bar"
                                        data-bs-target="#Year-bar" role="tab" aria-selected="false">Year</a>
                                </li>
                            </ul>
