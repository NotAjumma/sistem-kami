                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-3 col-xxl-4  email-left-body">
                            <div class="email-left-box generic-width px-0 mb-5 mt-4 mt-sm-0">
                                <div class="p-0">
                                            ...
                                            <div class="read-content">
                                                <div class="media pt-3 d-sm-flex d-block justify-content-between">
                                                    <div class="clearfix mb-3 d-flex">
                                                        <img class="me-3 rounded" width="70" height="70"
                                                            alt="image" src="{{ asset('images/avatar/1.jpg') }}">
                                                ...
                                                <div class="read-content-body">
                                                    ...
                                                    <p class="mb-2"><strong>Ingredia Nutrisha,</strong> A
                                                        ...
                                                        table - Samsa was a travelling salesman - and above
                                                        it there hung a picture</p>
                                                    ...
                                                    <p class="mb-2">Aenean vulputate eleifend tellus. Aenean
