                                ...
                                <ul class="nav nav-pills light" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab" data-bs-toggle="tab"
                                            data-bs-target="#BadgesSize-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="BadgesSize" role="tabpanel"
                                ...
                                <div class="tab-pane fade" id="BadgesSize-html" role="tabpanel"
                                    aria-labelledby="home-tab">
                                ...
                                <ul class="nav nav-pills light" id="myTab-1" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab-1" data-bs-toggle="tab"
                                            data-bs-target="#BadgesLight" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab-1" data-bs-toggle="tab"
                                            data-bs-target="#BadgesLight-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent-1">
                                <div class="tab-pane fade show active" id="BadgesLight" role="tabpanel"
                                ...
                                <div class="tab-pane fade" id="BadgesLight-html" role="tabpanel"
                                    aria-labelledby="home-tab-1">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">												
&lt;div class="bootstrap-badge"&gt;
                    ...
                    <div class="col-lg-12">
                        <div class="card dz-card" id="badges">
                                ...
                                <ul class="nav nav-pills light" id="myTab-2" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab-2" data-bs-toggle="tab"
                                            data-bs-target="#Badges" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab-2" data-bs-toggle="tab"
                                            data-bs-target="#Badges-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent-2">
                                ...
                                <div class="tab-pane fade " id="Badges-html" role="tabpanel"
                                    aria-labelledby="home-tab-2">
                                    <div class="card-body p-0 code-area">
                                ...
                                <ul class="nav nav-pills light" id="myTab-3" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab-3" data-bs-toggle="tab"
                                            data-bs-target="#PillBadge" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab-3" data-bs-toggle="tab"
                                            data-bs-target="#PillBadge-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent-3">
                                <div class="tab-pane fade show active" id="PillBadge" role="tabpanel"
                                ...
                                <div class="tab-pane fade" id="PillBadge-html" role="tabpanel"
                                    aria-labelledby="home-tab-3">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"> <code class="language-html">
&lt;div class="bootstrap-badge"&gt;
                                ...
                                <ul class="nav nav-pills light" id="myTab-4" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab-4" data-bs-toggle="tab"
                                            data-bs-target="#LinkBadge" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab-4" data-bs-toggle="tab"
                                            data-bs-target="#LinkBadge-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent-4">
                                <div class="tab-pane fade show active" id="LinkBadge" role="tabpanel"
                                ...
                                <div class="tab-pane fade" id="LinkBadge-html" role="tabpanel"
                                    aria-labelledby="home-tab-4">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">&lt;div class="bootstrap-badge"&gt;
&lt;a href="javascript:void(0)" class="badge badge-primary"&gt;Links&lt;/a&gt;
                                ...
                                <ul class="nav nav-pills light" id="myTab-5" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab-6" data-bs-toggle="tab"
                                            data-bs-target="#RoundedBadge" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab-6" data-bs-toggle="tab"
                                            data-bs-target="#RoundedBadge-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent-6">
                                <div class="tab-pane fade show active" id="RoundedBadge" role="tabpanel"
                                    aria-labelledby="home-tab-6">
                                    <div class="card-body">
                                        <div class="bootstrap-badge">
                                            <a href="javascript:void(0)"
                                                class="badge badge-rounded badge-primary">Rounded</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-rounded badge-secondary">Rounded</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-rounded badge-success">Rounded</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-rounded badge-danger">Rounded</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-rounded badge-warning">Rounded</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-rounded badge-info">Rounded</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-rounded badge-light">Rounded</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-rounded badge-dark">Rounded</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="RoundedBadge-html" role="tabpanel"
                                    aria-labelledby="home-tab-6">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">&lt;div class="bootstrap-badge"&gt;
                                ...
                                <ul class="nav nav-pills light" id="myTab-7" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab-7" data-bs-toggle="tab"
                                            data-bs-target="#OutlineBadge" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab-7" data-bs-toggle="tab"
                                            data-bs-target="#OutlineBadge-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent-7">
                                <div class="tab-pane fade show active" id="OutlineBadge" role="tabpanel"
                                ...
                                <div class="tab-pane fade " id="OutlineBadge-html" role="tabpanel"
                                    aria-labelledby="home-tab-7">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">&lt;div class="bootstrap-badge"&gt;
                                ...
                                <ul class="nav nav-pills light" id="myTab-8" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab-8" data-bs-toggle="tab"
                                            data-bs-target="#OutlineCircle" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab-8" data-bs-toggle="tab"
                                            data-bs-target="#OutlineCircle-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent-8">
                                <div class="tab-pane fade show active" id="OutlineCircle" role="tabpanel"
                                    aria-labelledby="home-tab-8">
                                    <div class="card-body pt-0">
                                        <div class="bootstrap-badge">
                                            <a href="javascript:void(0)"
                                                class="badge badge-circle badge-outline-primary">1</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-circle badge-outline-secondary">2</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-circle badge-outline-success">3</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-circle badge-outline-danger">4</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-circle badge-outline-warning">5</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-circle badge-outline-info">6</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-circle badge-outline-light">7</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-circle badge-outline-dark">8</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade " id="OutlineCircle-html" role="tabpanel"
                                    aria-labelledby="home-tab-8">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">&lt;div class="bootstrap-badge"&gt;
                                ...
                                <ul class="nav nav-pills light" id="myTab-9" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab-9" data-bs-toggle="tab"
                                            data-bs-target="#CircleBadge" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab-9" data-bs-toggle="tab"
                                            data-bs-target="#CircleBadge-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent-9">
                                <div class="tab-pane fade show active" id="CircleBadge" role="tabpanel"
                                    aria-labelledby="home-tab-9">
                                    <div class="card-body pt-0">
                                        <div class="bootstrap-badge">
                                            <a href="javascript:void(0)"
                                                class="badge badge-circle badge-primary">1</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-circle badge-secondary">2</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-circle badge-success">3</a>
                                            <a href="javascript:void(0)" class="badge badge-circle badge-danger">4</a>
                                            <a href="javascript:void(0)"
                                                class="badge badge-circle badge-warning">5</a>
                                ...
                                <div class="tab-pane fade" id="CircleBadge-html" role="tabpanel"
                                    aria-labelledby="home-tab-9">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">
&lt;div class="bootstrap-badge"&gt;
                                ...
                                <ul class="nav nav-pills light" id="myTab-10" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab-10" data-bs-toggle="tab"
                                            data-bs-target="#BadgeDefault" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab-10" data-bs-toggle="tab"
                                            data-bs-target="#BadgeDefault-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent-10">
                                <div class="tab-pane fade show active" id="BadgeDefault" role="tabpanel"
                                ...
                                <div class="tab-pane fade " id="BadgeDefault-html" role="tabpanel"
                                    aria-labelledby="home-tab-10">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">&lt;div class="bootstrap-badge"&gt;
&lt;a href="javascript:void(0)" class="badge badge-outline-primary"&gt;1&lt;/a&gt;
                                ...
                                <ul class="nav nav-pills light" id="myTab-11" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab-11" data-bs-toggle="tab"
                                            data-bs-target="#NumberBadge" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab-11" data-bs-toggle="tab"
                                            data-bs-target="#NumberBadge-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent-11">
                                <div class="tab-pane fade show active " id="NumberBadge" role="tabpanel"
                                ...
                                <div class="tab-pane fade " id="NumberBadge-html" role="tabpanel"
                                    aria-labelledby="home-tab-11">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">								
&lt;div class="card-body"&gt;
                                ...
                                <ul class="nav nav-pills light" id="myTab-12" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab-12" data-bs-toggle="tab"
                                            data-bs-target="#BadgeSizes" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab-12" data-bs-toggle="tab"
                                            data-bs-target="#BadgeSizes-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent-12">
                                <div class="tab-pane fade show active " id="BadgeSizes" role="tabpanel"
                                ...
                                <div class="tab-pane fade  " id="BadgeSizes-html" role="tabpanel"
                                    aria-labelledby="home-tab-12">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">
&lt;div class="bootstrap-badge"&gt;
