                            ...
                            <div class="card-header flex-wrap d-flex justify-content-between border-0 ">
                                <div>
                                    ...
                                    <p class="m-0 subtitle">The
                                        <code>.dropdown-divider</code> class is used to separate links inside the
                        ...
                        <div class="card dz-card" id="dropdown-header">
                            <div class="card-header flex-wrap border-0">
                                <div>
                                    ...
                                    <p class="m-0 subtitle">The
                                        <code>.dropdown-header</code> class is used to add headers inside the dropdown
                                        menu
                                    </p>
                                </div>
                        ...
                        <div class="card dz-card" id="dropright">
                            <div class="card-header flex-wrap border-0">
                                <div>
                                    ...
                                    <p class="m-0 subtitle">Trigger dropdown menus at the right of the elements by
                                        adding
                    ...
                    <div class="col-lg-12">
                        <div class="card dz-card" id="custom-style">
                            <div class="card-header flex-wrap border-0">
                                ...
                                <ul class="nav nav-pills light" id="myTab11" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-md-3 col-sm-4 col-6 ">
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" href="javascript:void(0);">Last 1
                                                            Month</a>
                                                        <a class="dropdown-item" href="javascript:void(0);">Last 6
                                                            Month</a>
                                                        <a class="dropdown-item" href="javascript:void(0);">Last 10
                                                            Month</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-3 col-sm-4 col-6 mb-3 mb-sm-0">
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" href="javascript:void(0);">Last 1
                                                            hour</a>
                                                        <a class="dropdown-item" href="javascript:void(0);">Last 2
                                                            hour</a>
                                                        <a class="dropdown-item" href="javascript:void(0);">Last 3
                                                            hour</a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-3 col-md-3 col-sm-4 col-6 mb-3 mb-sm-0">
                                                <div class="dropdown custom-dropdown">
                                                    <button type="button" class="btn btn-sm btn-primary flex-wrap"
                                                        data-bs-toggle="dropdown">
                                                        <i class="ti-calendar me-3"></i> March 20, 2018 &nbsp; To
                                                        &nbsp;April
                                                        20, 2018
                                                        <i class="fa fa-angle-down ms-3"></i>
                                                    </button>
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" href="javascript:void(0);">May 20,
                                                            2018 &nbsp; To &nbsp; June 20,
                                                            2018</a>
                                                        <a class="dropdown-item" href="javascript:void(0);">July 20,
                                                            2018 &nbsp; To &nbsp; August
                                                            20, 2018</a>
                                                    </div>
                                                </div>
