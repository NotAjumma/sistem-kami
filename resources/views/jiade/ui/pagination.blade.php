                                ...
                                <ul class="nav nav-pills light" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab" data-bs-toggle="tab"
                                            data-bs-target="#DefaultPagination" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab" data-bs-toggle="tab"
                                            data-bs-target="#DefaultPagination-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="DefaultPagination" role="tabpanel"
                                ...
                                <div class="tab-pane fade " id="DefaultPagination-html" role="tabpanel"
                                    aria-labelledby="home-tab">
                        ...
                        <div class="card dz-card" id="pagination-gutter">
                            <div class="card-header flex-wrap border-0 ">
                                <div>
                                    ...
                                    <p class="mb-0 subtitle">add <code>.pagination-gutter</code> to change the style
                                    </p>
                                </div>
                                <ul class="nav nav-pills light" id="myTab1" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab1" data-bs-toggle="tab"
                                            data-bs-target="#PaginationGutter" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab1" data-bs-toggle="tab"
                                            data-bs-target="#PaginationGutter-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent1">
                                <div class="tab-pane fade show active" id="PaginationGutter" role="tabpanel"
                                ...
                                <div class="tab-pane fade " id="PaginationGutter-html" role="tabpanel"
                                    aria-labelledby="home-tab1">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">&lt;nav&gt;
&lt;ul class="pagination pagination-gutter"&gt;
                                ...
                                <ul class="nav nav-pills light" id="myTab2" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab2" data-bs-toggle="tab"
                                            data-bs-target="#PaginationColor" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab2" data-bs-toggle="tab"
                                            data-bs-target="#PaginationColor-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent2">
                                <div class="tab-pane fade show active" id="PaginationColor" role="tabpanel"
                                ...
                                <div class="tab-pane fade " id="PaginationColor-html" role="tabpanel"
                                    aria-labelledby="home-tab2">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">&lt;nav&gt;
&lt;ul class="pagination pagination-gutter pagination-primary no-bg"&gt;
                        ...
                        <div class="card dz-card" id="pagination-circle">
                            <div class="card-header flex-wrap border-0 ">
                                <div>
                                    ...
                                    <p class="mb-0 subtitle">add <code>.pagination-circle</code> to change the style
                                    </p>
                                </div>
                                <ul class="nav nav-pills light" id="myTab3" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab3" data-bs-toggle="tab"
                                            data-bs-target="#PaginationCircle" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab3" data-bs-toggle="tab"
                                            data-bs-target="#PaginationCircle-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent3">
                                <div class="tab-pane fade show active" id="PaginationCircle" role="tabpanel"
                                ...
                                <div class="tab-pane fade " id="PaginationCircle-html" role="tabpanel"
                                    aria-labelledby="home-tab3">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"> <code class="language-html">&lt;nav&gt;
&lt;ul class="pagination pagination-circle"&gt;
