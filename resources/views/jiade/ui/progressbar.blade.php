                                ...
                                <ul class="nav nav-pills light" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab" data-bs-toggle="tab"
                                            data-bs-target="#DefaultProgressr" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab" data-bs-toggle="tab"
                                            data-bs-target="#DefaultProgressr-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="DefaultProgressr" role="tabpanel"
                                    aria-labelledby="home-tab">
                                    <div class="card-body pt-0">
                                        <div class="progress">
                                            <div class="progress-bar linear" style="width: 60%; height:10px;"
                                                role="progressbar">
                                ...
                                <div class="tab-pane fade" id="DefaultProgressr-html" role="tabpanel"
                                    aria-labelledby="home-tab">
                        ...
                        <div class="card dz-card" id="striped-progress">
                            <div class="card-header flex-wrap border-0">
                                <div>
                                    ...
                                    <p class="mb-0 subtitle">add <code>.progress-bar-striped</code> to change the style
                                    </p>
                                </div>
                                <ul class="nav nav-pills light" id="myTab1" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab1" data-bs-toggle="tab"
                                            data-bs-target="#StripedProgress" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab1" data-bs-toggle="tab"
                                            data-bs-target="#StripedProgress-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent1">
                                <div class="tab-pane fade show active" id="StripedProgress" role="tabpanel"
                                    aria-labelledby="home-tab1">
                                    <div class="card-body pt-0">
                                        <div class="progress">
                                            <div class="progress-bar bg-info progress-bar-striped" aria-valuenow="85"
                                                aria-valuemin="0" aria-valuemax="100" style="width: 85%; height:10px;"
                                                role="progressbar">
                                ...
                                <div class="tab-pane fade " id="StripedProgress-html" role="tabpanel"
                                    aria-labelledby="home-tab">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">&lt;div class="progress"&gt;
                        ...
                        <div class="card dz-card" id="colored-progress">
                            <div class="card-header flex-wrap border-0">
                                <div>
                                    ...
                                    <p class="mb-0 subtitle">add <code>bg-primary, .bg-danger, .bg-info</code> to
                                        change the style
                                    </p>
                                </div>
                                <ul class="nav nav-pills light" id="myTab3" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab3" data-bs-toggle="tab"
                                            data-bs-target="#ColoredProgress" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab3" data-bs-toggle="tab"
                                            data-bs-target="#ColoredProgress-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent3">
                                <div class="tab-pane fade show active" id="ColoredProgress" role="tabpanel"
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="progress mt-3">
                                            <div class="progress-bar bg-inverse" style="width: 40%; "
                                                role="progressbar">
                                                <span class="sr-only">60% Complete</span>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="ColoredProgress-html" role="tabpanel"
                                    aria-labelledby="home-tab3">
                                    <div class="card-body p-0 code-area">
                                ...
                                <ul class="nav nav-pills light" id="myTab4" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab4" data-bs-toggle="tab"
                                            data-bs-target="#Differentbar" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab4" data-bs-toggle="tab"
                                            data-bs-target="#Differentbar-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent4">
                                <div class="tab-pane fade show active" id="Differentbar" role="tabpanel"
                                    aria-labelledby="home-tab4">
                                    <div class="card-body pt-0">
                                        <div class="progress mt-3 h-auto">
                                ...
                                <div class="tab-pane fade" id="Differentbar-html" role="tabpanel"
                                    aria-labelledby="home-tab4">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">&lt;div class="progress mt-3 h-auto"&gt;
&lt;div class="progress-bar bg-danger" style="width: 60%; height:6px;" role="progressbar"&gt;
&lt;span class="sr-only"&gt;60% Complete&lt;/span&gt;
&lt;/div&gt;
&lt;/div&gt;
                    ...
                    <div class="col-xl-12">
                        <div class="card dz-card" id="animated-striped">
                            <div class="card-header flex-wrap border-0">
                                ...
                                <ul class="nav nav-pills light" id="myTab5" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab5" data-bs-toggle="tab"
                                            data-bs-target="#AnimatedStriped" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab5" data-bs-toggle="tab"
                                            data-bs-target="#AnimatedStriped-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent5">
                                <div class="tab-pane fade show active" id="AnimatedStriped" role="tabpanel"
                                ...
                                <div class="tab-pane fade " id="AnimatedStriped-html" role="tabpanel"
                                    aria-labelledby="home-tab5">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">&lt;div class="progress mt-3"&gt;
                        ...
                        <div class="card dz-card" id="vertical-progress">
                            <div class="card-header flex-wrap border-0">
                                <div>
                                    ...
                                    <p class="mb-0 subtitle">add <code>.progress-vertical</code> to change the style
                                    </p>
                                </div>
                                <ul class="nav nav-pills light" id="myTab6" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab6" data-bs-toggle="tab"
                                            data-bs-target="#VerticalProgress" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab6" data-bs-toggle="tab"
                                            data-bs-target="#VerticalProgress-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent6">
                                <div class="tab-pane fade show active" id="VerticalProgress" role="tabpanel"
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="progress progress-vertical">
                                            <div class="progress-bar bg-info" style="width:4px; height:80%;"
                                                role="progressbar">
                                                <span class="sr-only">60% Complete</span>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade " id="VerticalProgress-html" role="tabpanel"
                                    aria-labelledby="home-tab6">
                                    <div class="card-body p-0 code-area">
                    ...
                    <div class="col-xl-12">
                        <div class="card dz-card" id="vertical-progress-bottom">
                            <div class="card-header flex-wrap border-0">
                                ...
                                <ul class="nav nav-pills light" id="myTab7" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab7" data-bs-toggle="tab"
                                            data-bs-target="#Progressbottom" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab7" data-bs-toggle="tab"
                                            data-bs-target="#Progressbottom-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent7">
                                <div class="tab-pane fade show active" id="Progressbottom" role="tabpanel"
                                ...
                                <div class="tab-pane fade " id="Progressbottom-html" role="tabpanel"
                                    aria-labelledby="home-tab7">
                                    <div class="card-body p-0 code-area">
                    ...
                    <div class="col-xl-12">
                        <div class="card dz-card" id="different-size">
                            <div class="card-header flex-wrap border-0">
                                ...
                                <ul class="nav nav-pills light" id="myTab8" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab8" data-bs-toggle="tab"
                                            data-bs-target="#DifferentSize" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab8" data-bs-toggle="tab"
                                            data-bs-target="#DifferentSize-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent8">
                                <div class="tab-pane fade show active" id="DifferentSize" role="tabpanel"
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="progress progress-vertical">
                                            <div class="progress-bar bg-info" style="width:6px; height:80%;"
                                                role="progressbar">
                                                <span class="sr-only">60% Complete</span>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="DifferentSize-html" role="tabpanel"
                                    aria-labelledby="home-tab8">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">&lt;div class="progress progress-vertical"&gt;
&lt;div class="progress-bar bg-danger" style="width:4px; height:60%;" role="progressbar"&gt;
                    ...
                    <div class="col-xl-12">
                        <div class="card dz-card" id="animated-bars">
                            <div class="card-header flex-wrap border-0">
                                ...
                                <ul class="nav nav-pills light" id="myTab9" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab9" data-bs-toggle="tab"
                                            data-bs-target="#AnimatedBars" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab9" data-bs-toggle="tab"
                                            data-bs-target="#AnimatedBars-html" type="button" role="tab"
                                            aria-selected="false">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent9">
                                <div class="tab-pane fade show active" id="AnimatedBars" role="tabpanel"
                                    aria-labelledby="home-tab9">
                                    <div class="card-body pt-0">
                                        <div class="progress mt-3">
                                            <div class="progress-bar bg-danger progress-animated" style="width: 60%; "
                                                role="progressbar">
                                                <span class="sr-only">60% Complete</span>
                                            </div>
                                        </div>
                                        <div class="progress mt-3">
                                            <div class="progress-bar bg-info progress-animated" style="width: 40%; "
                                                role="progressbar">
                                                <span class="sr-only">60% Complete</span>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="AnimatedBars-html" role="tabpanel"
                                    aria-labelledby="home-tab9">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"> <code class="language-html">&lt;div class="progress mt-3"&gt;
                        ...
                        <div class="card dz-card" id="skill-bars">
                            <div class="card-header flex-wrap border-0">
                                <div>
                                    ...
                                    <p class="mb-0 subtitle">add <code>.progress-animated</code> to change the style
                                    </p>
                                </div>
                                <ul class="nav nav-pills light" id="myTab10" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab10" data-bs-toggle="tab"
                                            data-bs-target="#SkillBars" type="button" role="tab"
                                            aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab10" data-bs-toggle="tab"
                                            data-bs-target="#SkillBars-html" type="button"
                                            role="tab">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent10">
                                <div class="tab-pane fade show active" id="SkillBars" role="tabpanel"
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="progress ">
                                            <div class="progress-bar bg-danger progress-animated" style="width: 85%;"
                                                role="progressbar">
                                                <span class="sr-only">60% Complete</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar bg-info progress-animated" style="width: 90%; "
                                                role="progressbar">
                                                <span class="sr-only">60% Complete</span>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade " id="SkillBars-html" role="tabpanel"
                                    aria-labelledby="home-tab10">
                                    <div class="card-body p-0 code-area">
