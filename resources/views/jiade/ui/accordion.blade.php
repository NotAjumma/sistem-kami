                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#default-collapseOne"
                                                    aria-expanded="true" aria-controls="default-collapseOne">
                    ...
                    <div class="card dz-card" id="accordion-two">
                        <div class="card-header flex-wrap d-flex justify-content-between  border-0">
                            <div>
                                ...
                                <p class="m-0 subtitle">Accordion with border. Add class
                                    <code>accordion-bordered</code> with the class <code> accordion</code></p>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="accordion accordion-no-gutter accordion-header-bg">
                                        <div class="accordion-item">
                                            <h2 class="accordion-header">
                                                <button class="accordion-button" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#no-gutter-collapseOne">
                                                    Accordion Header One
                                                </button>
                                            </h2>
                    ...
                    <div class="card dz-card" id="accordion-five">
                        <div class="card-header flex-wrap d-flex justify-content-between  border-0">
                            <div>
                                ...
                                <p class="m-0 subtitle">Add <code>accordion-start-indicator</code> class with
                                    <code>accordion</code></p>
                            </div>
                            ...
                            <ul class="nav nav-pills light" id="myTab-5" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active " id="home-tab-5" data-bs-toggle="tab"
                                        data-bs-target="#widthicon" type="button" role="tab"
                                        aria-selected="true">Preview</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link " id="profile-tab-5" data-bs-toggle="tab"
                                        data-bs-target="#widthicon-html" type="button" role="tab"
                                        aria-controls="html" aria-selected="false">HTML</button>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content" id="myTabContent-5">
                            <div class="tab-pane fade show active" id="widthicon" role="tabpanel"
                                aria-labelledby="home-tab">
                                <div class="card-body">
                            ...
                            <div class="tab-pane fade" id="widthicon-html" role="tabpanel"
                                aria-labelledby="home-tab">
                                <div class="card-body pt-0 p-0 code-area">
                                    <pre class="mb-0"><code class="language-html">
&lt;div class="accordion accordion-with-icon"&gt;
                            ...
                            <ul class="nav nav-pills light" id="myTab-6" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active " id="home-tab-6" data-bs-toggle="tab"
                                        data-bs-target="#headerbackground" type="button" role="tab"
                                        aria-selected="true">Preview</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link " id="profile-tab-6" data-bs-toggle="tab"
                                        data-bs-target="#headerbackground-html" type="button" role="tab"
                                        aria-selected="false">HTML</button>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content" id="myTabContent-6">
                            <div class="tab-pane fade show active" id="headerbackground" role="tabpanel"
                                aria-labelledby="home-tab">
                                <div class="card-body">
                            ...
                            <div class="tab-pane fade" id="headerbackground-html" role="tabpanel"
                                aria-labelledby="home-tab">
                                <div class="card-body pt-0 p-0 code-area">
                            ...
                            <ul class="nav nav-pills light" id="myTab-7" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active " id="home-tab-7" data-bs-toggle="tab"
                                        data-bs-target="#solidbackground" type="button" role="tab"
                                        aria-selected="true">Preview</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link " id="profile-tab-7" data-bs-toggle="tab"
                                        data-bs-target="#solidbackground-html" type="button" role="tab"
                                        aria-selected="false">HTML</button>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content" id="myTabContent-7">
                            <div class="tab-pane fade show active" id="solidbackground" role="tabpanel"
                                aria-labelledby="home-tab">
                                <div class="card-body">
                            ...
                            <div class="tab-pane fade " id="solidbackground-html" role="tabpanel"
                                aria-labelledby="home-tab">
                                <div class="card-body pt-0 p-0 code-area">
                            ...
                            <ul class="nav nav-pills light" id="myTab-8" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active " id="home-tab-8" data-bs-toggle="tab"
                                        data-bs-target="#activebackground" type="button" role="tab"
                                        aria-selected="true">Preview</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link " id="profile-tab-8" data-bs-toggle="tab"
                                        data-bs-target="#activebackground-html" type="button" role="tab"
                                        aria-selected="false">HTML</button>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content" id="myTabContent-8">
                            <div class="tab-pane fade show active" id="activebackground" role="tabpanel"
                                aria-labelledby="home-tab">
                                <div class="card-body">
                            ...
                            <div class="tab-pane fade" id="activebackground-html" role="tabpanel"
                                aria-labelledby="home-tab">
                                <div class="card-body pt-0 p-0 code-area">
                                    <pre class="mb-0"><code class="language-html">
&lt;div class="accordion accordion-active-header"&gt;
                ...
                <div class="col-xl-12">
                    <div class="card dz-card " id="accordion-ten">
                            ...
                            <ul class="nav nav-pills light" id="myTab-10" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active " id="home-tab-10" data-bs-toggle="tab"
                                        data-bs-target="#headerShadow" type="button" role="tab"
                                        aria-selected="true">Preview</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link " id="profile-tab-10" data-bs-toggle="tab"
                                        data-bs-target="#headerShadow-html" type="button" role="tab"
                                        aria-selected="false">HTML</button>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="tab-content" id="myTabContent-10">
                            <div class="tab-pane fade show active" id="headerShadow" role="tabpanel"
                                aria-labelledby="home-tab">
                                <div class="card-body">
                            ...
                            <div class="tab-pane fade " id="headerShadow-html" role="tabpanel"
                                aria-labelledby="home-tab">
                            ...
                            <ul class="nav nav-pills light" id="myTab-11" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active " id="home-tab-11" data-bs-toggle="tab"
                                        data-bs-target="#roundedStylish" type="button" role="tab"
                                        aria-selected="true">Preview</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link " id="profile-tab-11" data-bs-toggle="tab"
                                        data-bs-target="#roundedStylish-html" type="button" role="tab"
                                        aria-selected="false">HTML</button>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content" id="myTabContent-11">
                            <div class="tab-pane fade show active" id="roundedStylish" role="tabpanel"
                                aria-labelledby="home-tab">
                                <div class="card-body">
                            ...
                            <div class="tab-pane fade" id="roundedStylish-html" role="tabpanel"
                                aria-labelledby="home-tab">
                                <div class="card-body pt-0 p-0 code-area">
                            ...
                            <ul class="nav nav-pills light" id="myTab-12" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active " id="home-tab-12" data-bs-toggle="tab"
                                        data-bs-target="#gradient" type="button" role="tab"
                                        aria-selected="true">Preview</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link " id="profile-tab-12" data-bs-toggle="tab"
                                        data-bs-target="#gradient-html" type="button" role="tab"
                                        aria-selected="false">HTML</button>
                                </li>
                            </ul>
                        </div>
                        <div class="tab-content" id="myTabContent-12">
                            <div class="tab-pane fade show active" id="gradient" role="tabpanel"
                                aria-labelledby="home-tab">
                                <div class="card-body">
                            ...
                            <div class="tab-pane fade " id="gradient-html" role="tabpanel"
                                aria-labelledby="home-tab">
                                <div class="card-body pt-0 p-0 code-area">
