                                ...
                                <ul class="nav nav-pills light" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab" data-bs-toggle="tab"
                                            data-bs-target="#DefaultTab-html" type="button"
                    ...
                    <div class="col-xl-12">
                        <div class="card dz-card" id="custom-tab">
                            ...
                            <div class="tab-content" id="myTabContent1">
                                ...
                                <div class="tab-pane fade " id="DefaultTab1-html" role="tabpanel"
                                    aria-labelledby="home-tab1">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"> <code class="language-html">&lt;!-- Nav tabs --&gt;
&lt;div class="custom-tab-1"&gt;
                    ...
                    <div class="col-xl-12">
                        <div class="card dz-card" id="nav-pills">
                                ...
                                <ul class="nav nav-pills light" id="myTab3" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab3" data-bs-toggle="tab"
                                            data-bs-target="#NavPills" type="button" role="tab"
                                            aria-controls="home" aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab3" data-bs-toggle="tab"
                                            data-bs-target="#NavPills-html" type="button"
                                            role="tab">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent3">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="tab-content">
                                            <div id="navpills-1" class="tab-pane active">
                                                <div class="row">
                                                    <div class="col-md-12"> Raw denim you probably haven't heard of
                                                        them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro
                                                        synth master cleanse. Mustache cliche tempor, williamsburg
                                            ...
                                            <div id="navpills-3" class="tab-pane">
                                                <div class="row">
                                                    <div class="col-md-12"> Raw denim you probably haven't heard of
                                                        them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro
                                                        synth master cleanse. Mustache cliche tempor, williamsburg
                                                        carles vegan helvetica.Raw denim you probably haven't heard of
                                                        them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro
                                                        synth master cleanse. Mustache cliche tempor, williamsburg
                                                        carles vegan helvetica.
                                                        <p>
                                ...
                                <div class="tab-pane fade" id="NavPills-html" role="tabpanel"
                                    aria-labelledby="home-tab3">
                                    <div class="card-body p-0 code-area">
                    ...
                    <div class="col-xl-12">
                        <div class="card dz-card" id="nav-pills-tabs">
                                ...
                                <ul class="nav nav-pills light" id="myTab4" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab4" data-bs-toggle="tab"
                                            data-bs-target="#NavPillsTabs" type="button" role="tab"
                                            aria-controls="home" aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab4" data-bs-toggle="tab"
                                            data-bs-target="#NavPillsTabs-html" type="button"
                                            role="tab">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent4">
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12"> Raw denim you probably haven't heard of
                                                        ...
                                                        <p>
                                                            <br> Reprehenderit butcher retro keffiyeh dreamcatcher
                                                            synth. Cosby sweater eu banh mi, qui irure terry richardson
                                                            ex squid retro synth master cleanse.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="navpills2-3" class="tab-pane">
                                                <div class="row">
                                                    <div class="col-md-12"> Raw denim you probably haven't heard of
                                                        them jean shorts Austin. Nesciunt tofu stumptown aliqua, retro
                                                        synth master retro synth master cleanse cleanse. Mustache cliche
                                ...
                                <div class="tab-pane fade " id="NavPillsTabs-html" role="tabpanel"
                                    aria-labelledby="home-tab4">
                                    <div class="card-body p-0 code-area">
                    ...
                    <div class="col-xl-12">
                        <div class="card dz-card" id="vertical-nav">
                                ...
                                <ul class="nav nav-pills light" id="myTab5" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab5" data-bs-toggle="tab"
                                            data-bs-target="#VerticalNav" type="button" role="tab"
                                            aria-controls="home" aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab5" data-bs-toggle="tab"
                                            data-bs-target="#VerticalNav-html" type="button"
                                            role="tab">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent5">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="tab-content">
                                                    <div id="v-pills-home" class="tab-pane fade active show">
                                                        <p>Cillum ad ut irure tempor velit nostrud occaecat ullamco
                                                            aliqua anim Lorem sint. Veniam sint duis incididunt do esse
                                                            magna mollit excepteur laborum qui. Id id reprehenderit sit
                                                            est eu aliqua occaecat quis
                                                            et velit excepteur laborum mollit dolore eiusmod. Ipsum
                                                            dolor in occaecat commodo et voluptate minim reprehenderit
                                                            mollit pariatur. Deserunt non laborum enim et cillum eu
                                                            deserunt excepteur ea incididunt
                                                            minim occaecat.
                                                        </p>
                                                    </div>
                                                    <div id="v-pills-profile" class="tab-pane fade">
                                                        <p>Culpa dolor voluptate do laboris laboris irure reprehenderit
                                                            id incididunt duis pariatur mollit aute magna pariatur
                                                            consectetur. Eu veniam duis non ut dolor deserunt commodo et
                                                            minim in quis laboris ipsum
                                                            velit id veniam. Quis ut consectetur adipisicing officia
                                                            excepteur non sit. Ut et elit aliquip labore Lorem enim eu.
                                                    ...
                                                    <div id="v-pills-messages" class="tab-pane fade">
                                                        <p>Fugiat id quis dolor culpa eiusmod anim velit excepteur
                                                            ...
                                                            nostrud magna nulla. Velit
                                                            et et proident Lorem do ea tempor officia dolor.
                                                    ...
                                                    <div id="v-pills-settings" class="tab-pane fade">
                                                        <p>Eu dolore ea ullamco dolore Lorem id cupidatat excepteur
                                                            ...
                                                            cillum duis aliqua do. Aliqua amet
                                                            qui mollit consectetur nulla mollit velit aliqua veniam nisi
                                                            id do Lorem deserunt amet. Culpa ullamco sit adipisicing
                                ...
                                <div class="tab-pane fade" id="VerticalNav-html" role="tabpanel"
                                    aria-labelledby="home-tab">
                                    <div class="card-body p-0 code-area">
                                ...
                                <ul class="nav nav-pills light" id="myTab6" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab6" data-bs-toggle="tab"
                                            data-bs-target="#VerticalNavPill" type="button" role="tab"
                                            aria-controls="home" aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab6" data-bs-toggle="tab"
                                            data-bs-target="#VerticalNavPill-html" type="button"
                                            role="tab">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent6">
                                <div class="tab-pane fade show active" id="VerticalNavPill" role="tabpanel"
                                ...
                                <div class="tab-pane fade" id="VerticalNavPill-html" role="tabpanel"
                                    aria-labelledby="home-tab6">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"> <code class="language-html">&lt;div class="row"&gt;
&lt;div class="col-sm-8"&gt;
                                ...
                                <ul class="nav nav-pills light" id="myTab7" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active " id="home-tab7" data-bs-toggle="tab"
                                            data-bs-target="#TabWithIcon" type="button" role="tab"
                                            aria-controls="home" aria-selected="true">Preview</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link " id="profile-tab7" data-bs-toggle="tab"
                                            data-bs-target="#TabWithIcon-html" type="button"
                                            role="tab">HTML</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent7">
                                <div class="tab-pane fade show active" id="TabWithIcon" role="tabpanel"
                                    aria-labelledby="home-tab7">
                                    <div class="card-body icon-tab pt-0">
                                        <!-- Nav tabs -->
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="nav-item">
                                ...
                                <div class="tab-pane fade" id="TabWithIcon-html" role="tabpanel"
                                    aria-labelledby="home-tab7">
                                    <div class="card-body p-0 code-area">
                                        <pre class="m-0"><code class="language-html">&lt;!-- Nav tabs --&gt;
&lt;ul class="nav nav-tabs" role="tablist"&gt;
