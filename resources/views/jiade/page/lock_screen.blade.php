    ...
    <div id="sign-up" class="auth-form tab-pane fade show active  form-validation">
        <form action="{{ url('index') }}">
            <div class="text-center mb-4">
                <h3 class="text-center mb-2 text-dark">Account Locked</h3>
                <span>Your Social Campaigns</span>
            </div>
            <div class="row mb-4">
                <div class="col-xl-6 col-12">
                    <a href="javascript:void(0);" class="btn btn-outline-dark d-block btn-block btn-sm social-bx">
                ...
                <div class="col-xl-6 col-12">
                    <a href="javascript:void(0);"
                        class="btn btn-outline-dark d-block btn-block btn-sm social-bx mt-xl-0 mt-3">
            ...
            <div class="sepertor">
                <span class="d-block mb-4 fs-13">with Password</span>
            </div>
        ...
        <div class="new-account mt-3 text-center">
            <p class="font-w500">Already have an account? <a class="text-primary" href="{{ url('index') }}"
