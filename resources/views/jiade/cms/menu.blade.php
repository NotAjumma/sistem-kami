                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="d-flex align-items-center flex-wrap mb-2">
                                                    ...
                                                    <a href="javascript:void(0);"
                                                        class="checkAllInput text-hover">Select All</a><span
                                                        class="mx-2">|</span>
                                                    <a href="javascript:void(0);"
                                                        class="unCheckAllInput text-hover">Deselect All</a>
                                                </div>
                    ...
                    <div class="filter cm-content-box box-primary">
                        <div class="content-title d-sm-flex d-block flex-wrap">
                            <div class="cpa d-flex align-items-center flex-wrap">
                                ...
                                <input type="text" class="form-control w-auto mb-sm-0 mb-3"
                                    placeholder="information">
                            </div>
                            <button type="button" class="btn btn-secondary btn-sm ms-sm-auto mb-2 mb-sm-0">Save
                                Menu</button>
                        </div>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Title
                                                                            Attribute</label>
                                                                        <input type="text"
                                                                            class="form-control solid" placeholder="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-12">
                                                                    <p class="dz-terms">Original: <a
